...
<head>
    ...
    <!-- Title CSS -->
    <title>Fixa - Transport & Logistics Bootstrap 5 Template</title>
    <!-- Favicon Link -->
    <link rel="icon" type="image/png" href="{{asset('home/img/favicon.png')}}">
</head>
<body>
<!-- PreLoader Start -->
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-md-6">
                <div class="header-left">
                    <ul>
                        <li>
                            <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#a0c8c5cccccfe0c6c9d8c18ec3cfcd">
                                <i class="icofont-ui-message"></i>
                                <span class="__cf_email__" data-cfemail="95fdf0f9f9fad5f3fcedf4bbf6faf8">[email&#160;protected]</span>
                            </a>
                        </li>
                        <li>
...
<div class="navbar-area">
    ...
    <div class="mobile-nav">
        <a href="index.html" class="logo">
            <img src="{{asset('home/img/logo.png')}}" class="main-logo" alt="logo">
            <img src="{{asset('home/img/logo-3.png')}}" class="white-logo" alt="logo">
        </a>
    </div>
                ...
                <div class="container">
                    <div class="banner-text">
                        ...
                        <div class="banner-btn">
                            <a href="contact.html" class="default-btn">Get a Free Call</a>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 wow animate__animated animate__fadeInUp" data-wow-duration="1s">
                <div class="transport-card">
                    <div class="transport-img">
                        <img src="{{asset('home/img/services/1.jpg')}}" alt="transport image">
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 wow animate__animated animate__fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                <div class="transport-card">
                    <div class="transport-img">
                        <img src="{{asset('home/img/services/2.jpg')}}" alt="transport image">
                    </div>
                    <div class="transport-text">
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6">
                <div class="quote-text">
                    ...
                    <div class="theme-btn">
                        <a href="contact.html" class="default-btn">Order Now</a>
                    </div>
                </div>
            </div>
...
<section class="worker-section pt-100 pb-70">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-sm-6 wow animate__animated animate__fadeInUp" data-wow-duration="1s">
                <div class="worker-card">
                    <div class="worker-img">
                        <img src="{{asset('home/img/worker/1.jpg')}}" alt="worker image">
                    </div>
            ...
            <div class="col-lg-3 col-sm-6 wow animate__animated animate__fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                <div class="worker-card">
                    <div class="worker-img">
                        <img src="{{asset('home/img/worker/2.jpg')}}" alt="worker image">
                    </div>
                    <div class="worker-text">
            ...
            <div class="col-lg-3 col-sm-6 wow animate__animated animate__fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                <div class="worker-card">
                    <div class="worker-img">
                        <img src="{{asset('home/img/worker/3.jpg')}}" alt="worker image">
                    </div>
                    <div class="worker-text">
                        <h3>Mark Tyson</h3>
            ...
            <div class="col-lg-3 col-sm-6 wow animate__animated animate__fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                <div class="worker-card">
                    <div class="worker-img">
                        <img src="{{asset('home/img/worker/4.jpg')}}" alt="worker image">
                    </div>
                    <div class="worker-text">
                        <h3>Jackson</h3>
                        <p>Road Freight Collector</p>
    ...
    <div class="container">
        ...
        <div class="feedback-slider owl-carousel owl-theme">
            ...
            <div class="feedback-items">
                ...
                <img src="{{asset('home/img/feedback/client-3.png')}}" alt="client image">
                <h3>John Doe</h3>
                <span>Businessman</span>
            </div>
        </div>
    ...
    <div class="container">
        <div class="company-slider owl-carousel owl-theme">
            <div class="company-logo">
                <a href="index.html"><img src="{{asset('home/img/company/1.png')}}" alt="logo"></a>
            </div>
            <div class="company-logo">
                <a href="index.html"><img src="{{asset('home/img/company/2.png')}}" alt="logo"></a>
            </div>
            <div class="company-logo">
                <a href="index.html"><img src="{{asset('home/img/company/3.png')}}" alt="logo"></a>
            </div>
            <div class="company-logo">
                <a href="index.html"><img src="{{asset('home/img/company/4.png')}}" alt="logo"></a>
            </div>
            <div class="company-logo">
                <a href="index.html"><img src="{{asset('home/img/company/5.png')}}" alt="logo"></a>
            </div>
        </div>
    </div>
</div>
...
<section class="blog-section pt-100 pb-70">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 wow animate__animated animate__fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html"><img src="{{asset('home/img/blog/2.png')}}" alt="blog image"></a>
                    </div>
                    <div class="blog-text">
                        <h3>
            ...
            <div class="col-lg-4 col-sm-6   wow animate__animated animate__fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                <div class="blog-card">
                    <div class="blog-img">
                        <a href="blog-details.html"><img src="{{asset('home/img/blog/3.png')}}" alt="blog image"></a>
                    </div>
                    <div class="blog-text">
                        <h3>
...
<footer class="footer-area">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-sm-6">
                <div class="footer-widget">
                    <a href="index.html">
                        <img src="{{asset('home/img/logo-2.png')}}" alt="logo">
                    </a>
                    <ul>
                        <li>
                            <i class="icofont-phone"></i>
                        ...
                        <li>
                            <i class="icofont-ui-message"></i>
                            <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#9ff7faf3f3f0dff9f6e7feb1fcf0f2">
                                <span class="__cf_email__" data-cfemail="036b666f6f6c43656a7b622d606c6e">[email&#160;protected]</span>
                            </a>
                        </li>
    ...
    <div class="copyright-area">
        <p>© <span>Fixa</span> is Proudly Owned by <a href="https://hibootstrap.com/" target="_blank">HiBoostrap</a></p>
    </div>
